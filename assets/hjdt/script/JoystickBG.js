...
cc.Class({
    ...
    Init: function () {
        ...
        console.log("_initTouchEvent2 " + this._joyCom.touchType);
    ...
    {
        if(this.roleControl == null)
        {
            return;
        }
        if(this._speed == 0)
        {
            this.roleControl.keyLeft = false;
            this.roleControl.keyRight = false;
            return;
        }
        if(this._angle<90 && this._angle> -90)
        {
            this.roleControl.keyLeft = false;
            this.roleControl.keyRight = true;
        }
        else
        {
            this.roleControl.keyLeft = true;
            this.roleControl.keyRight = false;
        }
